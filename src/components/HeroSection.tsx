...
const Herosection = () => {
  return (
    <div className="relative  bg-[#00B4D8] w-full h-[716px]">
      {/* Background Image */}
      <Image
        src="/images/Girl.png"
        alt="maingirl"
      ...
      {/* Text Overlay */}
      <div className=" ml-[150px] absolute inset-0 flex flex-col justify-center items-center sm:items-start p-8 sm:p-12">
